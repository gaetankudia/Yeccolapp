...
class LivreDetailsPage extends StatelessWidget {
  final int livreId;

  const LivreDetailsPage({Key key, this.livreId}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    final Lecon lecon = listlecons.singleWhere((lecon) => lecon.id == livreId);
